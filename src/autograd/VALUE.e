...
feature -- Initialization
    ...
    make_with_children (a_data: REAL_64; a_children: ARRAYED_LIST [VALUE]; a_op_code: INTEGER)
...
feature -- Operations
    ...
    power alias "^" (other: REAL_64): VALUE
            -- Power: Current ^ `other`.
        local
            l_children: ARRAYED_LIST [VALUE]
        do
    ...
    negated alias "-": VALUE
            -- Negation.
        do
            Result := Current * create {VALUE}.make (-1.0)
        end
...
feature -- Autograd
    ...
    build_topo (v: VALUE; topo: ARRAYED_LIST [VALUE])
        do
